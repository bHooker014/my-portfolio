...
const Skill = ({ directionLeft }: Props) => {
    return (
        <motion.div className='group relative flex cursor-pointer'>
            ...
            />
            <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white w-24 h-20 md:w-28 md:h-28 xl:w-32 xl:h-32 rounded-full z-0'>
