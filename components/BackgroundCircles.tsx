...
export default function BackgroundCircles (props: Props) {
  return (
    ...
    className='relitive flex justify-center items-center'>
        ...
        <div className='absolute border border-[#253fec] rounded-full opacity-20 h-[650px] w-[650px] mt-52 animate-pulse' />
